...
import com.dvargas.adaschool.cornershop.domain.services.products.AuthService
import com.dvargas.adaschool.cornershop.domain.services.products.HealthService
import com.dvargas.adaschool.cornershop.domain.services.products.UserService
...
object AdaServiceNetworkModule {

    @Provides
    @Named("ada")
    fun providesHealthService(@Named("ada") retrofit: Retrofit): HealthService {
        return retrofit.create(HealthService::class.java)
    }

    @Provides
    @Named("ada")
    fun providesAuthService(@Named("ada") retrofit: Retrofit): AuthService {
        return retrofit.create(AuthService::class.java)
    }

    @Provides
    @Named("ada")
    fun provideUserService(@Named("ada") retrofit: Retrofit): UserService {
        return retrofit.create(UserService::class.java)
    }

    @Provides
    @Named("ada")
    fun provideLoginService(@Named("ada") retrofit: Retrofit): LoginService {
    ...
    fun providesRetrofit(): Retrofit {
        ...
        return Retrofit.Builder().baseUrl("https://products-api.up.railway.app/")
            .client(okHttpClient)
